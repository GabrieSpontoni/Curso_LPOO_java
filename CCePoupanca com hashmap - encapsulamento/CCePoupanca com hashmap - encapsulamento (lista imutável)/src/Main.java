...
public class Main {
	...
	public static void main(String[] args) {
		...
		//SaldoTotal
		SaldoTotal saldoTotal = new SaldoTotal();
		System.out.println("*SALDO TOTAL* = "+saldoTotal.calculaSaldoTotal(bradesco));
		System.out.println("\n\n");
		System.out.println("ANTES DO CLEAR, LISTA DE CONTAS RETORNADAS = "+bradesco.getContas());
		bradesco.getContas().clear();
		System.out.println("DEPOIS DO CLEAR, LISTA DE CONTAS RETORNADAS = "+bradesco.getContas());
